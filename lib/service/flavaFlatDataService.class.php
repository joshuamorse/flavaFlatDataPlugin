...
class flavaFlatDataService
{
   ...
   * @return void
   */
  public function __construct($repositoryPath, flavaFlatDataLoaderInterface $parseService)
  {
    $this->filter = array(
      'leftValue' => null,
      'operator' => null,
  ...
  {
    return $this->parseService->loadRepository($this->repositoryPath . $repository . '.' . $this->repositoryExtension);
  }
